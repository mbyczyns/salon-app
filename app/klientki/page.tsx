                    ...
                    <table className="w-full text-left border-collapse min-w-[600px]">
                        <thead>
                            <tr className="bg-slate-50/80 text-slate-500 border-b-2 border-slate-100 font-[family-name:var(--font-oswald-bold)] tracking-wider uppercase text-sm">
                                ...
                                <th className="py-4 px-6 font-normal text-right">Akcje</th>
                            </tr>
                        </thead>
                    ...
                    >
                        ...
                        >
                            <div className="p-6 border-b border-slate-100 flex justify-between items-center bg-pink-50">
                                ...
                                <button
                                    onClick={() => setIsModalOpen(false)}
                                    className="p-2 text-slate-400 hover:text-pink-500 rounded-full transition-colors flex items-center justify-center bg-white"
                                >
                            ...
                            <form onSubmit={handleAddClient} className="p-6 md:p-8 flex flex-col gap-5">
                                ...
                                <div className="mt-4 pt-4 flex gap-3">
                                    ...
                                    <button
                                        type="submit"
                                        className="flex-1 py-3 bg-pink-400 text-white font-[family-name:var(--font-oswald-bold)] tracking-widest uppercase hover:bg-pink-500 rounded-lg transition-colors shadow-sm"
                                    >
                                        Zapisz
                                    </button>
                                </div>
